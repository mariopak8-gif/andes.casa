...
const Navbar = () => {
  ...
  return (
    <nav className="hidden md:flex fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md shadow-sm z-50 border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between">
        ...
        <ul className="hidden lg:flex gap-8 items-center list-none text-sm font-medium">
          ...
          <li>
            ...
            >
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${isActive("/profile") ? "bg-emerald-100 text-emerald-700" : "bg-emerald-100 text-emerald-700"}`}
              >
