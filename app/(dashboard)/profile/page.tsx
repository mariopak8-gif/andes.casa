        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between">
          ...
          <ul className="hidden lg:flex gap-8 items-center list-none text-sm font-semibold">
            ...
            <li>
              <Link
                href="/profile"
                className="flex items-center gap-2 pl-6 border-l border-gray-200 group text-emerald-600 relative after:content-[''] after:absolute after:-bottom-1 after:left-6 after:w-[calc(100%-1.5rem)] after:h-0.5 after:bg-emerald-500 after:rounded-full"
              >
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex-1 bg-white/20 backdrop-blur-sm border border-white/30 rounded-lg px-3 py-2 font-mono text-center font-bold tracking-widest text-white">
                      {user?.invitationCode ||
                        (session as any)?.user?.invitationCode ||
                        "------"}
                    </div>
                    <button
              ...
              <div className="bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div className="ml-auto text-gray-400 group-hover:text-emerald-500">
                      →
                    </div>
                  </Link>
                  ...
                  <Link
                    href="/team"
                    className="flex items-center gap-4 p-4 rounded-xl border border-gray-100 hover:border-purple-200 hover:bg-purple-50 transition-all group"
                  >
                    ...
                    <div className="ml-auto text-gray-400 group-hover:text-purple-500">
                      →
                    </div>
                  </Link>
                  ...
                  >
                    ...
                    <div className="ml-auto text-gray-400 group-hover:text-blue-500">
                      →
                    </div>
                  </Link>
                </div>
